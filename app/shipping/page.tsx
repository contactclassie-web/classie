    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14 prose prose-sm max-w-none">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10 not-prose">
          {[
            ...
            <div key={title} className="flex gap-4 bg-[#faf8f6] rounded-2xl p-5 border border-classie-border">
              <Icon className="w-5 h-5 text-[#3B5373] flex-shrink-0 mt-0.5" />
              <div>
        ...
        <PolicySection title="Order Tracking">
          <p>Once dispatched, you'll receive tracking details via SMS/WhatsApp. Use our <a href="/track-order" className="text-[#3B5373] underline">Track Order</a> page for real-time updates.</p>
        </PolicySection>
        ...
        <PolicySection title="Lost or Damaged Packages">
          <p>If your order arrives damaged or is lost in transit, please contact us within 48 hours of the expected delivery date at <a href="mailto:hello@classie.co.in" className="text-[#3B5373] underline">hello@classie.co.in</a> or WhatsApp us.</p>
        </PolicySection>
      </div>
    </>
  );
